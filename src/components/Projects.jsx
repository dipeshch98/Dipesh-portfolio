...
const projectData = [
  {
    image: "/src/images/rkworkshop.png",
    title: "RK Workshop",
    description: "A simple website for RK Workshop to schowcase services, location, and contact details for a local motor repair shop.",
